...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pompom':
				tex = Paths.getSparrowAtlas('pompom_assets');
				frames = tex;
			...
			case 'pompom-mad':
				frames = Paths.getSparrowAtlas('pompommad_assets');
				animation.addByPrefix('idle-alt', 'pompom mad idle', 24, false);
				animation.addByPrefix('singUP-alt', 'pompom mad up', 24, false);
				animation.addByPrefix('singDOWN-alt', 'pompom mad down', 24, false);
				animation.addByPrefix('singLEFT-alt', 'pompom mad left', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'pompom mad right', 24, false);

				animation.addByPrefix('idle', 'pompom sad idle', 24, false);
				animation.addByPrefix('singUP', 'pompom sad up', 24, false);
				animation.addByPrefix('singDOWN', 'pompom sad down', 24, false);
				animation.addByPrefix('singLEFT', 'pompom sad left', 24, false);
				animation.addByPrefix('singRIGHT', 'pompom sad right', 24, false);

				addOffset('idle-alt', 0, -250);
				addOffset("singUP-alt", -20, -220);
				addOffset("singRIGHT-alt", 0, -275);
				addOffset("singLEFT-alt", 0, -243);
				addOffset("singDOWN-alt", 0, -315);
				addOffset('idle',  -50, -260);
				addOffset("singUP", -20, -250);
				addOffset("singRIGHT", -30, -260);
				addOffset("singLEFT", -20, -260);
				addOffset("singDOWN", -20, -286);

				playAnim('idle');

			case 'mackie':
				frames = Paths.getSparrowAtlas('mackie_assets');
				animation.addByPrefix('idle', 'mackie idle', 24, false);
				animation.addByPrefix('singUP', 'mackie up', 24, false);
				animation.addByPrefix('singDOWN', 'mackie down', 24, false);
				animation.addByPrefix('singLEFT', 'mackie left', 24, false);
				animation.addByPrefix('singRIGHT', 'mackie right', 24, false);
				animation.addByPrefix('intro', 'walk', 24, false);

				addOffset("idle", 0, -510);
				addOffset("singUP", -20, -451);
				addOffset("singRIGHT", 0, -450);
				addOffset("singLEFT", -6, -465);
				addOffset("singDOWN", 9, -515);
				addOffset("intro", 220, -470);

			case 'mackiepom':
				frames = Paths.getSparrowAtlas('mackiepom_assets');
				...
				animation.addByPrefix('pomintro', 'pompom intro', 24, false);
				animation.addByPrefix('three', 'three', 24, false);
				animation.addByPrefix('two', 'two', 24, false);
				animation.addByPrefix('one', 'one', 24, false);
				...
				addOffset("pomintro", 900, -200);
				addOffset("three", 0, -230);
				addOffset("two", 0, -230);
				addOffset("one", 0, -230);
		}
