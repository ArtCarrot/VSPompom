...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'pompom' => new CharacterSetting(-20, 40, 1.0),
		'mackie' => new CharacterSetting(-40, -45, 1.0)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('pompom', "pomstory", 24);
		animation.addByPrefix('mackie', "mackie story", 24);
